          ...
          <Grid>
            ...
            <Grid.Col>
              <Flex align={"center"} justify={"right"}>
                <Button onClick={isEditing ? editParty : addParty}>
                  {isEditing ? "Edit Party" : "Save Party"}
                </Button>
              </Flex>
            </Grid.Col>
          </Grid>
