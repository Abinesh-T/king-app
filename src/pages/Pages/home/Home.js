  ...
  return (
    <>
      ...
      <Flex align={"center"} wrap={"wrap"} p={"5%"} gap={"6%"}>
        {
          info.map((e, i) => (
            <Flex onClick={() => { navigate(e.link) }} direction={"column"} align={"center"} justify={"center"} w={"47%"} mb={"6%"} h={"132px"} style={{ boxShadow: "rgba(0, 0, 0, 0.2) 0px 3px 1px -2px, rgba(0, 0, 0, 0.14) 0px 2px 2px 0px, rgba(0, 0, 0, 0.12) 0px 1px 5px 0px", borderRadius: "5%", cursor: "pointer" }}>
              {e.icon}
